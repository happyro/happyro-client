/**
 * UI/Components/MiniMap/MiniMapCommon.js
 *
 * Shared MiniMap factory
 *
...
export function createMiniMap({
	...
	if (townInfoToggle) {
		_preferencesDefault.townInfoShow = true;
	}
	const _preferences = Preferences.get(name, _preferencesDefault, 1.0);
