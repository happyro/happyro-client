export function requestGameToolsConfirmation(container, message) {
	return new Promise(resolve => {
		...
		overlay.innerHTML =
			'<div class="game-tools-confirm-card" role="dialog" aria-modal="true"><p></p><div><button type="button" data-cancel>取消</button><button type="button" data-confirm>确认</button></div></div>';
