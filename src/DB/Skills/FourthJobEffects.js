...
export const fourthJobEffectResources = {
	...
	SHC_ENCHANTING_SHADOW: { effectId: [
	...
	AG_RAIN_OF_CRYSTAL: { beginCastEffectId: [
	...
	WH_DEEPBLINDTRAP: { beginCastEffectId: 'deepblindtrap/deepblindtrap_cast/deepblindtrap_cast', hitEffectId: 'deepblindtrap/deepblindtrap_hit/deepblindtrap_hit' },
	WH_SOLIDTRAP: { beginCastEffectId: 'solidtrap/solidtrap_cast/solidtrap_cast', hitEffectId: 'solidtrap/solidtrap_hit/solidtrap_hit' },
	WH_SWIFTTRAP: { beginCastEffectId: 'swifttrap/swifttrap_cast/swifttrap_cast', hitEffectId: 'swifttrap/swifttrap_hit/swifttrap_hit' },
	WH_FLAMETRAP: { beginCastEffectId: 'flametrap/flametrap_cast/flametrap_cast', hitEffectId: 'flametrap/flametrap_hit/flametrap_hit' },
	...
	IG_CROSS_RAIN: { beginCastEffectId: [
	...
	ABC_ABYSS_DAGGER: { effectId: 'abyss_dagger/abyss_dagger/abyss_dagger', hitEffectId: 'abyss_dagger/abyss_dagger_hit/abyss_dagger_hit' },
	ABC_UNLUCKY_RUSH: { effectId: 'unlucky_rush/unlucky_rush_cast/unlucky_rush_cast', hitEffectId: 'unlucky_rush/unlucky_rush_hit/unlucky_rush_hit' },
	...
	ABC_ABYSS_STRIKE: {
		...
		effectId: ['abyss_strike/abyss_strike/abyss_strike', 'abyss_strike/abyss_strike_bottom/abyss_strike_bottom', 'abyss_strike/abyss_strike_ground/abyss_strike_ground', 'abyss_strike/abyss_strike_ground_bottom/abyss_strike_ground_bottom'],
	...
	ABC_FRENZY_SHOT: { beforeHitEffectId: 'frenzy_shot/frenzy_shot/frenzy_shot', hitEffectId: 'frenzy_shot/frenzy_shot_hit/frenzy_shot_hit' },
	BO_ACIDIFIED_ZONE_WATER: { beginCastEffectId: ['acidified_zone_water/acidified_zone_water_cast/acidified_zone_water_cast', 'acidified_zone_water/acidified_zone_water_cast_bottom/acidified_zone_water_cast_bottom'], hitEffectId: 'acidified_zone_water/acidified_zone_water_hit/acidified_zone_water_hit' },
	BO_ACIDIFIED_ZONE_GROUND: { beginCastEffectId: ['acidified_zone_ground/acidified_zone_ground_cast/acidified_zone_ground_cast', 'acidified_zone_ground/acidified_zone_ground_cast_bottom/acidified_zone_ground_cast_bottom'], hitEffectId: 'acidified_zone_ground/acidified_zone_ground_hit/acidified_zone_ground_hit' },
	BO_ACIDIFIED_ZONE_WIND: { beginCastEffectId: ['acidified_zone_wind/acidified_zone_wind_cast/acidified_zone_wind_cast', 'acidified_zone_wind/acidified_zone_wind_cast_bottom/acidified_zone_wind_cast_bottom'], hitEffectId: 'acidified_zone_wind/acidified_zone_wind_hit/acidified_zone_wind_hit' },
	BO_ACIDIFIED_ZONE_FIRE: { beginCastEffectId: ['acidified_zone_fire/acidified_zone_fire_cast/acidified_zone_fire_cast', 'acidified_zone_fire/acidified_zone_fire_cast_bottom/acidified_zone_fire_cast_bottom'], hitEffectId: 'acidified_zone_fire/acidified_zone_fire_hit/acidified_zone_fire_hit' },
	...
	EM_LIGHTNING_LAND: { beginCastEffectId: ['lightning_land/lightning_land_cast/lightning_land_cast', 'lightning_land/lightning_land_cast_bottom/lightning_land_cast_bottom'], hitEffectId: 'lightning_land/lightning_land_hit/lightning_land_hit' },
	EM_VENOM_SWAMP: { beginCastEffectId: ['venom_swamp/venom_swamp_cast/venom_swamp_cast', 'venom_swamp/venom_swamp_cast_bottom/venom_swamp_cast_bottom'], hitEffectId: 'venom_swamp/venom_swamp_hit/venom_swamp_hit' },
	EM_CONFLAGRATION: { beginCastEffectId: ['conflagration/conflagration_cast/conflagration_cast', 'conflagration/conflagration_cast_bottom/conflagration_cast_bottom'], hitEffectId: 'conflagration/conflagration_hit/conflagration_hit' },
	EM_ELEMENTAL_BUSTER: { beginCastEffectId: 'elemental_buster/elemental_buster_cast/elemental_buster_cast' },
	EM_ELEMENTAL_BUSTER_FIRE: { effectId: ['elemental_buster/elemental_buster/elemental_buster_fire/elemental_buster_fire', 'elemental_buster/elemental_buster/elemental_buster_fire_bottom/elemental_buster_fire_bottom'], hitEffectId: 'elemental_buster/elemental_buster_hit/elemental_buster_fire_hit/elemental_buster_fire_hit' },
	EM_ELEMENTAL_BUSTER_WATER: { effectId: ['elemental_buster/elemental_buster/elemental_buster_water/elemental_buster_water', 'elemental_buster/elemental_buster/elemental_buster_water_bottom/elemental_buster_water_bottom'], hitEffectId: 'elemental_buster/elemental_buster_hit/elemental_buster_water_hit/elemental_buster_water_hit' },
	EM_ELEMENTAL_BUSTER_WIND: { effectId: ['elemental_buster/elemental_buster/elemental_buster_wind/elemental_buster_wind', 'elemental_buster/elemental_buster/elemental_buster_wind_bottom/elemental_buster_wind_bottom'], hitEffectId: 'elemental_buster/elemental_buster_hit/elemental_buster_wind_hit/elemental_buster_wind_hit' },
	EM_ELEMENTAL_BUSTER_GROUND: { effectId: ['elemental_buster/elemental_buster/elemental_buster_land/elemental_buster_land', 'elemental_buster/elemental_buster/elemental_buster_land_bottom/elemental_buster_land_bottom'], hitEffectId: 'elemental_buster/elemental_buster_hit/elemental_buster_land_hit/elemental_buster_land_hit' },
	EM_ELEMENTAL_BUSTER_POISON: { effectId: ['elemental_buster/elemental_buster/elemental_buster_poison/elemental_buster_poison', 'elemental_buster/elemental_buster/elemental_buster_poison_bottom/elemental_buster_poison_bottom'], hitEffectId: 'elemental_buster/elemental_buster_hit/elemental_buster_poison_hit/elemental_buster_poison_hit' },
	IQ_JUDGE: { effectId: ['4ig_judge/judge_start/judge_start', '4ig_judge/judge/judge', '4ig_judge/judge_aura/judge_aura'] },
	TR_ROSEBLOSSOM: {
	...
	TR_AIN_RHAPSODY: { beginCastEffectId: 'ain_rhapsody/ain_rhapsody_cast/ain_rhapsody_cast', effectId: 'ain_rhapsody/ain_rhapsody/ain_rhapsody' },
	TR_GEF_NOCTURN: { beginCastEffectId: ['gef_nocturn/gef_nocturn_cast/gef_nocturn_cast', 'gef_nocturn/gef_nocturn_cast_bottom/gef_nocturn_cast_bottom'], effectId: 'gef_nocturn/gef_nocturn/gef_nocturn' },
	TR_ROKI_CAPRICCIO: { beginCastEffectId: ['roki_capriccio/roki_capriccio_cast/roki_capriccio_cast', 'roki_capriccio/roki_capriccio_cast_bottom/roki_capriccio_cast_bottom'], effectId: 'roki_capriccio/roki_capriccio/roki_capriccio' },
	TR_MUSICAL_INTERLUDE: { beginCastEffectId: 'musical_interlude/musical_interlude_cast/musical_interlude_cast', effectId: 'musical_interlude/musical_interlude/musical_interlude' },
	TR_JAWAII_SERENADE: { beginCastEffectId: ['jawaii_serenade/jawaii_serenade_cast/jawaii_serenade_cast', 'jawaii_serenade/jawaii_serenade_cast_bottom/jawaii_serenade_cast_bottom'], effectId: 'jawaii_serenade/jawaii_serenade/jawaii_serenade' },
	HN_JUPITEL_THUNDER_STORM: {
		...
		hitEffectId: ['hyper_novice/hn_jupitel_thunder_storm/jupitel_thunder_storm/jupitel_thunder_storm_00', 'hyper_novice/hn_jupitel_thunder_storm/jupitel_thunder_storm/jupitel_thunder_storm_01', 'hyper_novice/hn_jupitel_thunder_storm/jupitel_thunder_storm/jupitel_thunder_storm_02']
	}
};
...
for (const [skill, stages] of Object.entries(fourthJobEffectResources)) {
	...
	for (const [stage, files] of Object.entries(stages)) {
		...
		fourthJobRenderEffects[key] = [files].flat().map(file => ({
			type: 'STR', file, texturePath: file.slice(0, file.lastIndexOf('/') + 1)
		}));
	}
